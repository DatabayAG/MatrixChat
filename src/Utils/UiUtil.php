...
namespace ILIAS\Plugin\MatrixChat\Utils;
...
class UiUtil
{
    ...
    {
        $this->dic->ui()->mainTemplate()->setOnScreenMessage(MessageBox::INFO, $message, $keep);
    }

    public function sendFailure(string $message, bool $keep = true): void
    {
        $this->dic->ui()->mainTemplate()->setOnScreenMessage(MessageBox::FAILURE, $message, $keep);
    }

    public function sendSuccess(string $message, bool $keep = true): void
    {
        $this->dic->ui()->mainTemplate()->setOnScreenMessage(MessageBox::SUCCESS, $message, $keep);
    }
}
